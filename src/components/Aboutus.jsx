...
function Aboutus() {
  return (
    ...
    <>
      <section class="about-section border border-1 border-primary py-5">
          ...
          <div class="row no-gutters position-relative">
            <div class="left-header d-none d-lg-block col-lg-3 col-xl-4">
              <div class="v-center-box d-flex align-items-end text-uppercase">
                <h2 class="mb-0 text-center">About Me</h2>
              </div>
            </div>
              ...
              <div class="main-content p-5">
                ...
                <div class="row mb-5">
                  <div class="mb-5 mb-sm-4 col-md-4">
                    <img src="https://www.freepik.com/free-photos-vectors/animal" alt="Colorful Wall" />
                  </div>
                  <div class="col-md-8">
